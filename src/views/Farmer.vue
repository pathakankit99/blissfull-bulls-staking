<template>
  <ConfigPane />
  <div v-if="!wallet" class="hidden text-center text-lg font-medium bg-blue-600 text-white p-6">
  Refresh the page to connect wallet
  </div>
  <div v-else>
    <!--farm address-->
    <div class="center bg-blue-600 hidden text-white with-title mb-10 hidden">
    ...
    <div v-else>
      <div class="w-full text-center mb-5 bg-red-600 py-6 text-red-100">
...
export default defineComponent({
  ...
  setup() {
    ...
    // --------------------------------------- farmer details
    //2gNpvuT6hM9C3zvfxEx3fctM9XXgSVmvTrR3mm5FvmV6//test
